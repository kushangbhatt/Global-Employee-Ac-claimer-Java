		...
		xmlhttp.onreadystatechange = function() {
			if (xmlhttp.readyState == 4) {
				...
				for(i=0 ; i<jsonObj.length ; i++)
				{
					...
					var loan_desc = document.getElementById("loan_desc");
					rt.value = jsonObj[i].rate;
					amount.value = jsonObj[i].amount;
					loan_desc.value = jsonObj[i].loan_desc;
					
				}
			}
		}
		xmlhttp.open("get","${pageContext.request.contextPath}/loan_controller?flag=loadrate&loan_id="+loan_id.value, true);
		xmlhttp.send();
        ...
        <section class="wrapper retracted scrollable">
            ...
            <div class="row">
                ...
                <div class="col-md-6 col-lg-6">
                        <form action="<%=request.getContextPath() %>/loan_controller" name="loan_form" method="post" data-parsley-namespace="data-parsley-" data-parsley-validate>
                        <input type="hidden" name="flag" value="insertE"/>
                        
                            <div class="panel panel-default panel-block">
                                <div class="list-group">
                                    <div class="list-group-item">
                                        <h4 class="section-title">Loan Detail Client</h4>

                                        <div class="form-group">
											<label>Loan Type <span class="text-danger">*</span></label>
											<select class="form-control" id="loan_id" name="lt" onchange="loadInfo();">
											<option value="Select Type">Select Loan Type</option>
											<c:forEach items="${sessionScope.loan_list }" var="i">
												<option value="${i.id }">${i.loan_type }</option>
                                            </c:forEach>
											</select>
										</div>
                                        ...
                                        <div class="form-group" id="rate">
                                            ...
                                            <input type="text" id="rt" class="form-control" placeholder="Amount Allowed" data-parsley-required="true" Disabled>
                                        </div>
										
										<div class="form-group">
                                            <label>Maximum Amount</label>
                                            <input type="text" id="amount" class="form-control" placeholder="Amount Allowed" data-parsley-required="true" Disabled>
                                        </div>
                                        <div class="form-group">
                                            <label>Loan Description</label>
                                            <textarea class="form-control" id="loan_desc" rows="5" placeholder="Loan Description" Disabled></textarea>
                                        </div>
                                        
										<div class="form-group">
                                            <label>Amount</label>
                                            <input type="text" name="amount" class="form-control" placeholder="Amount Allowed" data-parsley-required="true">
                                        </div>
