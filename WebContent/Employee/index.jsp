...
<!--[if gt IE 9]><!--> <html class="no-js"> <!--<![endif]-->
    <head>
        ...
        <link rel="stylesheet" href="../Admin/Css/jquery.pnotify.default.css">
    ...
    <body class="dashboard-page">
                ...
                <div id="latest-users-widget" class="proton-widget latest-users">
                    ...
                    <div class="panel panel-info front">
                        ...
                        <div>
                            <ul class="list-group pending">
                                <li class="list-group-item">
                                    <i><img src="../Admin/Images/user3.jpg" alt="User Icon"></i>
                                    <div class="text-holder">
                                        <span class="title-text">
                                            Etiam Libero
                                        </span>
        ...
        <script src="../Admin/Js/e9e962ee.dashboard.js"></script>
        <script src="../Admin/Js/61b9ced9.dashdemo.js"></script>
        ...
        <!-- Number formating for dashboard demo -->
            <script src="../Admin/Js/numeral.min.js"></script>

        <!-- Notifications -->
        <!-- http://pinesframework.org/pnotify/ -->
            <script src="../Admin/Js/jquery.pnotify.min.js"></script>
    </body>
</html>
