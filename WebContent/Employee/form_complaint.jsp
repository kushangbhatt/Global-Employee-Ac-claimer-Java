...
<!-- Fonts CSS: -->
<link rel="stylesheet" href="../Admin/Css/6227bbe5.font-awesome.css"
	type="text/css" />
<link rel="stylesheet" href="../Admin/Css/40ff7bd7.font-titillium.css"
	type="text/css" />
...
<!--         AJAX  -->
  ...
  function loadname()
		...
		xmlhttp.onreadystatechange = function() {
			if (xmlhttp.readyState == 4) {
				...
				for(i=0 ; i<jsonObj.length ; i++)
				{
					...
					createOption.value=jsonObj[i].name_id;
					createOption.text=jsonObj[i].name;
					
					document.complaint_form.to_id.options.add(createOption);
					
				}
			}
		}

		xmlhttp.open("get","${pageContext.request.contextPath}/complaint_controller?flag=loadname&type="+type.value, true);
		xmlhttp.send();
	...
	{
		var removename=document.complaint_form.to.options.length;
		for(i=removename ; i>0 ; i-- )
		{ 	
			document.complaint_form.to.remove(i);
		}
	}
</script>
	...
	<section class="wrapper retracted scrollable">
		...
		<nav class="user-menu">
			...
			<div class="panel panel-default nav-view messages-view">
				...
				<ul class="list-group">
					<li class="list-group-item"><i><img
							src="../Admin/Images/user1.jpg" alt="User Icon"></i>
						<div class="text-holder">
					...
					<li class="list-group-item"><i><img
							src="../Admin/Images/user5.jpg" alt="User Icon"></i>
						<div class="text-holder">
					...
					<li class="list-group-item"><i><img
							src="../Admin/Images/user2.jpg" alt="User Icon"></i>
						<div class="text-holder">
			...
			<div class="panel panel-default nav-view notifications-view">
				...
				<ul class="list-group">
					...
					<li class="list-group-item"><i><img
							src="../Admin/Images/user4.jpg" alt="User Icon"></i>
						<div class="text-holder">
			...
			<li class="group"><a data-toggle="dropdown" href="#">Manage
				...
				<ul class="dropdown-menu dropdown-menu-arrow" role="menu">
					<li role="presentation"><a role="menuitem" tabindex="-1"
						href="Leavedtl_form.jsp">Add Leave</a></li>
					<li role="presentation"><a role="menuitem" tabindex="-1"
						href="forms-masked-input-fields.html">Search Leave</a></li>
		...
		<div class="row">
			...
			<div class="col-md-6 col-lg-6">
				<form action="<%=request.getContextPath()%>/complaint_controller"
					method="post" name="complaint_form" data-parsley-namespace="data-parsley-"
						...
						<div class="list-group">
							<div class="list-group-item">
								...
								<div class="form-group">
									<label>Type: <span class="text-danger">*</span></label> <select
								...
								<div class="form-group">
									<label>To <span class="text-danger">*</span></label> <select
										class="form-control" id="to_id" name="to">
										<option value="Select ToName">Select To:</option>
<%-- 										<c:forEach items="${sessionScope.employee_details }" var="list"> --%>
...
<%-- 										</c:forEach> --%>
								...
								<div class="form-group">
									<label>Subject:</label> <input type="text" class="form-control"
										name="sub" placeholder="Whome to complaint"
						...
						<footer class="panel-footer text-right">
							<button type="submit" class="btn btn-success">Apply for
								Leave</button>
