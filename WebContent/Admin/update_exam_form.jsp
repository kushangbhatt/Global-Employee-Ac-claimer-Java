                                ...
                                <div class="list-group">
                                    <div class="list-group-item">
										...
										<div class="form-group">
                                            ...
                                            <input type="text" name="no" class="form-control" value="${l.no_q }" data-parsley-required="true">
                                        </div>
										<div class="form-group">
                                            <label>Examtime <span class="text-danger">*</span></label>
                                            <input type="text" name="etime" class="form-control" value="${l.e_duration }" data-parsley-required="true">
                                        </div>
										<div class="form-group">
                                            <label>Examdiscription</label>
                                            <textarea class="form-control" name="ed" rows="5">${e_desc }</textarea>
                                        </div>
										</c:forEach>
