...
<!--[if gt IE 9]><!--> <html class="no-js"> <!--<![endif]-->
    <head>
        ...
        <title>GEA - Country Tables</title>
    ...
    <body>
        ...
        <section class="wrapper retracted scrollable">
            ...
            <ol class="breadcrumb breadcrumb-nav">
                ...
                <li class="active">
                    <a data-toggle="dropdown" href="#">Search Country</a>
                ...
                <div class="col-md-12">
                    <div class="panel panel-default panel-block">
                    	<div id="data-table" class="panel-heading datatable-heading">
                            <h4 class="section-title">Country Detail</h4>
                    	</div>
	                        ...
	                        <tbody>
	                        	<c:forEach  items="${sessionScope.list }" var="l">
		                            <tr>
		                                ...
		                                <td>${l.country }</td>
		                                <td>${l.cnt_desc }</td>
		                                <td><a href="<%=request.getContextPath() %>/country_controller?flag=loadsrc&id=${l.id }"><button type="button" class="btn btn-sm btn-primary">Update</button></a> | <a href="<%=request.getContextPath() %>/country_controller?flag=delete&id=${l.id }"><button type="button" class="btn btn-sm btn-danger">Delete</button></a></td>
									</tr>
	                    		</c:forEach>
	                        </tbody>
	                    </table>
