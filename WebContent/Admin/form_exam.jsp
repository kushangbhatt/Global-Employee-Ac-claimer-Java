...
<!--[if gt IE 9]><!--> <html class="no-js"> <!--<![endif]-->
  ...
  function loadcat()
	{
		var e_type=document.getElementById("e_type");
		...
		xmlhttp.onreadystatechange = function() {
			if (xmlhttp.readyState == 4) {
				...
				for(i=0 ; i<jsonObj.length ; i++)
				{
					...
					createOption.value=jsonObj[i].cat_id;
					createOption.text=jsonObj[i].cat_name;
					
					document.exam_form.ec.options.add(createOption);
					
				}
			}
		}

		xmlhttp.open("get","${pageContext.request.contextPath}/exam_controller?flag=loadcat&e_type_id="+e_type.value, true);
		xmlhttp.send();
  ...
  function loadsubcat()
		...
		xmlhttp.onreadystatechange = function() {
			if (xmlhttp.readyState == 4) {
				...
				for(i=0 ; i<jsonObj.length ; i++)
				{
					...
					createOption.value=jsonObj[i].subcat_id;
					createOption.text=jsonObj[i].subcat_name;
					
					document.exam_form.esc.options.add(createOption);
					
				}
			}
		}

		xmlhttp.open("get","${pageContext.request.contextPath}/exam_controller?flag=loadsubcat&cat_id="+cat_id.value, true);
		xmlhttp.send();
		/* jQuery(".chosen-select1").chosen({'width':'100%','white-space':'nowrap'}); */
		/* Holds the status of the XMLHttpRequest. Changes from 0 to 4:
			0: request not initialized
	...
	{
		var removeCategory=document.exam_form.ec.options.length;
		for(i=removeCategory ; i>0 ; i-- )
		{ 	
			document.exam_form.ec.remove(i);
		}
	}
	
	function removeAllSubcategory()
	{
		var removeCategory=document.exam_form.esc.options.length;
		for(i=removeCategory ; i>0 ; i-- )
		{ 	
			document.exam_form.esc.remove(i);
		}
	}
</script>
    </head>
    ...
    <body>
        ...
        <section class="wrapper retracted scrollable">
            ...
            <ol class="breadcrumb breadcrumb-nav">
                ...
                <li class="group">
                    <a data-toggle="dropdown" href="#">Manage Exam</a>
                    <ul class="dropdown-menu dropdown-menu-arrow" role="menu">
                        <li role="presentation"><a role="menuitem" tabindex="-1" href="exam_form.jsp">Add Exam</a></li>
                        <li role="presentation"><a role="menuitem" tabindex="-1" href="forms-masked-input-fields.html">Search Exam</a></li>
            ...
            <div class="row">
                ...
                <div class="col-md-6 col-lg-6">
                        <form action="../exam_controller" method="post" name="exam_form" data-parsley-namespace="data-parsley-" data-parsley-validate>
                        <input type="hidden" name="flag" value="insert"/>
                            <div class="panel panel-default panel-block">
                                <div class="list-group">
                                    <div class="list-group-item">
                                        <h4 class="section-title">Exam Form</h4>

										<div class="form-group">
											<label>Exam Type<span class="text-danger">*</span></label>
											<select class="form-control" id="e_type" name="et" onchange="loadcat()">
											<option value="select ExamType">Select Exam Type</option>
											<c:forEach items="${sessionScope.list }" var="i">
												<option value="${i.id }">${i.e_type }</option>
                                            </c:forEach>
											</select>
										</div>
										...
										<div class="form-group">
											...
											<select class="form-control" id="cat_id" name="ec" onchange="loadsubcat()">
											<option value="Select Category">Select Category</option>
                                            </select>
										</div>
										<div class="form-group">
											<label>Exam subcategory</label>
											<select class="form-control" id="subcat_id" name="esc">
											<option value="Select Subcategory"> Select Subcategory</option>
    										</select>
										</div>
										<div class="form-group">
                                            <label>No of Q. <span class="text-danger">*</span></label>
                                            <input type="text" name="no" class="form-control" placeholder="no of question" data-parsley-required="true">
                                        </div>
										<div class="form-group">
                                            <label>Examtime <span class="text-danger">*</span></label>
                                            <input type="text" name="etime" class="form-control" placeholder="Examtime" data-parsley-required="true">
                                        </div>
										<div class="form-group">
                                            <label>Examdiscription</label>
                                            <textarea class="form-control" name="ed" rows="5" placeholder="Exam_discription"></textarea>
                                        </div>
