                            ...
                            <div class="panel panel-default panel-block">
                                <div class="list-group">
                                    <div class="list-group-item">
                                        ...
                                        <h4 class="section-title">Category Detail</h4>
										...
										<input type="hidden" name="id" value="${u.id }">
                                            ...
                                            <input type="text" class="form-control" value="${u.cat }" placeholder="Category" data-parsley-required="true" name="cat">
                                            </c:forEach>
                                        </div>
										...
										<div class="form-group">
                                            ...
                                            <c:forEach items="${sessionScope.ulist }" var="u">
                                            <textarea class="form-control" rows="5" placeholder="Category Description" name="desc">${u.desc }</textarea>
                                            </c:forEach>
                                        </div>
