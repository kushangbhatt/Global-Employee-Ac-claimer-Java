        ...
        <section class="wrapper retracted scrollable">
            ...
            <div class="row">
                ...
                <div class="col-md-6 col-lg-6">
                        <form action="<%=request.getContextPath() %>/cat_controller" method="post" data-parsley-namespace="data-parsley-" data-parsley-validate>
                                ...
                                <div class="list-group">
                                    <div class="list-group-item">
										...
										<div class="form-group">
											...
											<select class="form-control" id="e_type" name="et">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" placeholder="Category" data-parsley-required="true" name="cat">
                                        </div>
										
										<div class="form-group">
                                            <label>Category Description</label>
                                            <textarea class="form-control" rows="5" placeholder="Category Description" name="desc"></textarea>
                                        </div>
                                    </div>
                                </div>
