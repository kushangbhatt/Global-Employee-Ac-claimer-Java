                                ...
                                <div class="list-group">
                                    <div class="list-group-item">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="lt" class="form-control" placeholder="Loan Type" data-parsley-required="true">
                                        </div>
										...
										<div class="form-group">
                                            ...
                                            <input type="text" name="rate" class="form-control" placeholder="Interest Rate" data-parsley-required="true">
                                        </div>
