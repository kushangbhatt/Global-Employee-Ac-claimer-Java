    ...
    <body>
        ...
        <section class="wrapper retracted scrollable">
            ...
            <ol class="breadcrumb breadcrumb-nav">
                ...
                <li class="active">
                    <a data-toggle="dropdown" href="#">Search Employee</a>
	                        ...
	                        <tbody>
	                        	<c:forEach  items="${sessionScope.list }" var="l">
		                            <tr>
										...
										<td>${l.phn }</td>
										<td><a href="<%=request.getContextPath() %>/emp_controller?flag=loadsrc&id=${l.id }"><button type="button" class="btn btn-sm btn-primary">Update</button></a> | <a href="<%=request.getContextPath() %>/emp_controller?flag=delete&id=${l.id }"><button type="button" class="btn btn-sm btn-danger">Delete</button></a></td>
									</tr>
	                    		</c:forEach>
	                        </tbody>
	                    </table>
