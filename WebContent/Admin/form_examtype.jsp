        ...
        <section class="wrapper retracted scrollable">
            ...
            <div class="row">
                ...
                <div class="col-md-6 col-lg-6">
                        <form action="<%=request.getContextPath() %>/etype_controller" method="post" data-parsley-namespace="data-parsley-" data-parsley-validate>
                            <div class="panel panel-default panel-block">
                                <div class="list-group">
                                    <div class="list-group-item">
                                        <h4 class="section-title">Exam Type Detail</h4>
										<input type="hidden" name="flag" value="insert">
                                        <div class="form-group">
                                            <label>Exam Type <span class="text-danger">*</span></label>
                                            <input type="text" class="form-control" placeholder="Exam Type" data-parsley-required="true" name="et">
                                        </div>
										
										<div class="form-group">
                                            <label>Category Description</label>
                                            <textarea class="form-control" rows="5" placeholder="Examtype Description" name="e_desc"></textarea>
                                        </div>
                                    </div>
                                </div>
