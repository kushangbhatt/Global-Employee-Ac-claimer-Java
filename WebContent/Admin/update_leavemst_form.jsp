                                ...
                                <div class="list-group">
                                    <div class="list-group-item">
                                        ...
                                        <input type="hidden" value="${l.id }" name="id">
                                            ...
                                            <input type="text" class="form-control" value="${l.leave_type }" name="lt" data-parsley-required="true">
                                        </div>
										
										
										<div class="form-group">
                                            <label>No of Leave Allowed</label>
                                            <input type="text" class="form-control" value="${l.leave_no }" name="no" data-parsley-required="true">
                                        </div>
										<div class="form-group">
                                            <label>Leave Description</label>
                                            <textarea class="form-control" rows="5" name="ld">${l.leave_desc }</textarea>
                                        </div>
										</c:forEach>
