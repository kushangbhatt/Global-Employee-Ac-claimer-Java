    ...
    <body>
        ...
        <section class="wrapper retracted scrollable">
            ...
            <ol class="breadcrumb breadcrumb-nav">
                ...
                <li class="group">
                    <a data-toggle="dropdown" href="#">Manage State</a>
                    <ul class="dropdown-menu dropdown-menu-arrow" role="menu">
                        <li role="presentation"><a role="menuitem" tabindex="-1" href="state_form.jsp">Add State</a></li>
                        <li role="presentation"><a role="menuitem" tabindex="-1" href="forms-masked-input-fields.html">Search state</a></li>
            ...
            <div class="row">
                ...
                <div class="col-md-6 col-lg-6">
                        <form action="<%=request.getContextPath() %>/state_controller" method="post" data-parsley-namespace="data-parsley-" data-parsley-validate>
                            <input type="hidden" name="flag" value="insert"/>
                            <div class="panel panel-default panel-block">
                                <div class="list-group">
                                    <div class="list-group-item">
                                        <h4 class="section-title">State Details</h4>
                                        
                                        <div class="form-group">
											<label>Country<span class="text-danger">*</span></label>
											<select class="form-control" id="source" name="cnt">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="st" class="form-control" placeholder="Add State" data-parsley-required="true">
                                        </div>
										<div class="form-group">
                                            <label>State Description <span class="text-danger">*</span></label>
                                            <textarea class="form-control" name="sd" rows="5" placeholder="State Description"></textarea>
                                        </div>
                                     </div>
                                </div>
