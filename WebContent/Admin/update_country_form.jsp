    ...
    <body>
        ...
        <section class="wrapper retracted scrollable">
            ...
            <ol class="breadcrumb breadcrumb-nav">
                ...
                <li class="group">
                    <a data-toggle="dropdown" href="#">Manage Country</a>
                    <ul class="dropdown-menu dropdown-menu-arrow" role="menu">
                        <li role="presentation"><a role="menuitem" tabindex="-1" href="form_country.jsp">Add Country</a></li>
                        <li role="presentation"><a role="menuitem" tabindex="-1" href="forms-masked-input-fields.html">Search Country</a></li>
                                ...
                                <div class="list-group">
                                    <div class="list-group-item">
										...
										<div class="form-group">
                                            ...
                                            <input type="text" name="cnt" class="form-control" value="${l.country }" data-parsley-required="true">
                                        </div>
										<div class="form-group">
                                            <label>Country Description</label>
                                            <textarea class="form-control" name="cntd" rows="5" >${l.cnt_desc }</textarea>
                                        </div>
                                        </c:forEach>
                                    </div>
                                </div>
