    ...
    <body>
        ...
        <section class="wrapper retracted scrollable">
            ...
            <ol class="breadcrumb breadcrumb-nav">
                ...
                <li class="active">
                    <a data-toggle="dropdown" href="#">Search City</a>
                ...
                <div class="col-md-12">
                    <div class="panel panel-default panel-block">
                    	<div id="data-table" class="panel-heading datatable-heading">
                            <h4 class="section-title">City Detail</h4>
                    	</div>
	                        ...
	                        <tbody>
	                        	<c:forEach  items="${sessionScope.list }" var="l">
		                            <tr>
		                                ...
		                                <td>${l.city }</td>
		                                <td>${l.ct_desc }</td>
		                                <td><a href="<%=request.getContextPath() %>/city_controller?flag=loadsrc&id=${l.id }"><button type="button" class="btn btn-sm btn-primary">Update</button></a> | <a href="<%=request.getContextPath() %>/city_controller?flag=delete&id=${l.id }"><button type="button" class="btn btn-sm btn-danger">Delete</button></a></td>
									</tr>
	                    		</c:forEach>
	                        </tbody>
	                    </table>
