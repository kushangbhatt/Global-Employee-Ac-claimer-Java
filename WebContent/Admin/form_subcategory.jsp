...
<!--         Ajax Code -->
  ...
  function loadcat()
		...
		xmlhttp.onreadystatechange = function() {
			if (xmlhttp.readyState == 4) {
				...
				for(i=0 ; i<jsonObj.length ; i++)
				{
					...
					document.subcat_form.ec.options.add(createOption);
					
				}
			}
		}

		xmlhttp.open("get","${pageContext.request.contextPath}/subcat_controller?flag=loadcat&e_type_id="+e_type.value, true);
		xmlhttp.send();
	...
	{
		var removeCategory=document.subcat_form.ec.options.length;
		for(i=removeCategory ; i>0 ; i-- )
		{ 	
			document.subcat_form.ec.remove(i);
		}
	}
</script>
        ...
        <section class="wrapper retracted scrollable">
            ...
            <ol class="breadcrumb breadcrumb-nav">
                ...
                <li class="group">
                    ...
                    <ul class="dropdown-menu dropdown-menu-arrow" role="menu">
                        <li role="presentation"><a role="menuitem" tabindex="-1" href="exam_form.jsp">Add Subcategory</a></li>
                        <li role="presentation"><a role="menuitem" tabindex="-1" href="forms-masked-input-fields.html">Search Subcategory</a></li>
            ...
            <div class="row">
                ...
                <div class="col-md-6 col-lg-6">
                        <form action="<%=request.getContextPath() %>/subcat_controller" method="post" name="subcat_form" data-parsley-namespace="data-parsley-" data-parsley-validate>
                            <div class="panel panel-default panel-block">
                                <div class="list-group">
                                    <div class="list-group-item">
                                        <h4 class="section-title">Subcategory Details</h4>
										...
										<div class="form-group">
											...
											<option value="select category">Select Exam Type</option>
										...
										<div class="form-group">
											...
											<select class="form-control" id="cat" name="ec">
                                            <option value="Select Category">Select Category</option>
                                            </select>
										</div>
                                        <div class="form-group">
                                            <label>Subcategory <span class="text-danger">*</span></label>
                                            <input type="text" class="form-control" id="subcat" placeholder="Add Subcategory" data-parsley-required="true" name="subcat">
                                        </div>
										
										<div class="form-group">
                                            <label>Subcategory Description</label>
                                            <textarea class="form-control" rows="5" placeholder="Subcategory Description" name="desc"></textarea>
                                        </div>
                                    </div>
                                </div>
