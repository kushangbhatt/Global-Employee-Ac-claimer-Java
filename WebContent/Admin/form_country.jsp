        ...
        <section class="wrapper retracted scrollable">
            ...
            <ol class="breadcrumb breadcrumb-nav">
                ...
                <li class="group">
                    ...
                    <ul class="dropdown-menu dropdown-menu-arrow" role="menu">
                        ...
                        <li role="presentation"><a role="menuitem" tabindex="-1" href="forms-masked-input-fields.html">Add Category</a></li>
            ...
            <div class="row">
                ...
                <div class="col-md-6 col-lg-6">
                        <form action="<%=request.getContextPath() %>/country_controller" method="post" data-parsley-namespace="data-parsley-" data-parsley-validate>
                        <input type="hidden" name="flag" value="insert"/>
                            <div class="panel panel-default panel-block">
                                <div class="list-group">
                                    <div class="list-group-item">
                                        <h4 class="section-title">Country Details</h4>
										</div>
										<div class="form-group">
                                            <label>Country <span class="text-danger">*</span></label>
                                            <input type="text" name="cnt" class="form-control" placeholder="Add Country" data-parsley-required="true">
                                        </div>
										<div class="form-group">
                                            <label>Country Description</label>
                                            <textarea class="form-control" name="cntd" rows="5" placeholder="Country Description"></textarea>
                                        </div>
                                    </div>
                                </div>
