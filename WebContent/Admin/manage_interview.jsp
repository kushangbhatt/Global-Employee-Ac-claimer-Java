    ...
    <body>
        ...
        <section class="wrapper retracted scrollable">
            ...
            <ol class="breadcrumb breadcrumb-nav">
                ...
                <li class="active">
                    <a  data-toggle="dropdown" href="#">Manage Interview</a>
                ...
                <div class="col-md-12">
                    ...
                    <div class="panel panel-default panel-block">
                    	<div id="data-table" class="panel-heading datatable-heading">
                            <h4 class="section-title">Short Listed Table</h4>
                    	</div>
	                    <table class="table table-bordered table-striped" id="tableSortable">
	                        ...
	                        <tbody>
	                            <tr class="gradeX">
									...
									<td class="center">4</td>
	                                <td class="center"><button type="button" class="btn btn-sm btn-primary">Invite</button></td>
	                            </tr>
	                            <tr class="gradeC">
	                                <td>Trident</td>
	                                <td>Internet
