...
<!--         AJAX  -->
		...
		xmlhttp.onreadystatechange = function() {
			if (xmlhttp.readyState == 4) {
				...
				for(i=0 ; i<jsonObj.length ; i++)
				{
					...
					document.empForm.st.options.add(createOption);
					
				}
			}
		}

		xmlhttp.open("get","${pageContext.request.contextPath}/emp_controller?flag=loadst&country_id="+country_id.value, true);
		xmlhttp.send();
  ...
  function loadCity()
		...
		xmlhttp.onreadystatechange = function() {
			if (xmlhttp.readyState == 4) {
				...
				for(i=0 ; i<jsonObj.length ; i++)
				{
					...
					document.empForm.ct.options.add(createOption);
	...
	{
		var removeState=document.empForm.state_id.options.length;
		for(i=removeState ; i>0 ; i-- )
		{ 	
			document.empForm.st.remove(i);
		}
	}
	
	function removeAllCity()
	{
		var removeCity=document.empForm.city_id.options.length;
		for(i=removeCity ; i>0 ; i-- )
		{ 	
			document.empForm.ct.remove(i);
		}
	}
</script>
			...
			<li class="group"><a data-toggle="dropdown" href="#">Manage
				...
				<ul class="dropdown-menu dropdown-menu-arrow" role="menu">
					<li role="presentation"><a role="menuitem" tabindex="-1"
						href="employee_dtl.jsp">Add Employee</a></li>
					<li role="presentation"><a role="menuitem" tabindex="-1"
						href="forms-masked-input-fields.html">Search Employee</a></li>
							...
							<div class="list-group-item">
								...
								<div class="form-group">
									<label>Name <span class="text-danger">*</span></label> <input
										type="text" name="nm" class="form-control"
										placeholder="Username" data-parsley-required="true">
								</div>
								<div class="form-group">
									<label>Address<span class="text-danger">*</span></label>
									<textarea class="form-control" name="ad" rows="5"
								...
								<div class="form-group">
									<label>City<span class="text-danger">*</span></label> <select
										class="form-control" id="city_id" name="ct">
								...
								<div class="form-group">
									...
									<input type="text" value="15/05/2014" name="dob"
										class="datetimepicker-month form-control">
								...
								<div class="form-group">
									<label>Email <span class="text-danger">*</span></label> <input
										type="text" name="em" class="form-control" placeholder="Email"
										data-parsley-type="email" data-parsley-required="true">
								</div>
								
								<div class="form-group">
									<label>Password <span class="text-danger">*</span></label> <input
										type="password" name="ps" class="form-control"
										placeholder="Password" data-parsley-required="true">
								</div>

								<div class="form-group">
									<label>Phone <span class="text-danger">*</span></label> <input
										type="text" name="ph" class="form-control"
										placeholder="Enter Phone" data-parsley-type="phone"
										data-parsley-required="true">
								</div>
								<div class="form-group">
									<label>Qualification <span class="text-danger">*</span></label>
									<input type="text" class="form-control"
										placeholder="Qualification" data-parsley-required="true"
										name="q">
								</div>
								<div class="form-group">
									<label>Department <span class="text-danger">*</span></label> <input
										type="text" class="form-control" placeholder="Department"
										data-parsley-required="true" name="dept">
								</div>
								<div class="form-group">
									<label>Salary <span class="text-danger">*</span></label> <input
										type="text" class="form-control" placeholder="Salary"
										data-parsley-required="true" name="salary">
								</div>
								<div class="form-group">
