    ...
    <body>
        ...
        <section class="wrapper retracted scrollable">
            ...
            <ol class="breadcrumb breadcrumb-nav">
                ...
                <li class="active">
                    <a  data-toggle="dropdown" href="#">Search Loan</a>
                ...
                <div class="col-md-12">
                    ...
                    <div class="panel panel-default panel-block">
	                    ...
	                    <table class="table table-bordered table-striped" id="tableSortable">
	                        ...
	                        <tbody>
	                        	<c:forEach items="${sessionScope.loan_list }" var="l">
	                            	<tr>
	                            		<td>${l.id }</td>
	                            		<td>${l.loan_type }</td>
	                            		<td>${l.amount }</td>
	                            		<td>${l.rate }</td>
	                            		<td>${l.loan_desc }</td>
	                            		<td><a href="<%=request.getContextPath() %>/loan_controller?flag=loadsrc&id=${l.id }"><button type="button" class="btn btn-sm btn-primary">Update</button></a> | <a href="<%=request.getContextPath() %>/loan_controller?flag=delete&id=${l.id }"><button type="button" class="btn btn-sm btn-danger">Delete</button></a></td>
	                            	</tr>
	                            </c:forEach>
	                        </tbody>
	                    </table>
