    ...
    <body>
        ...
        <section class="wrapper retracted scrollable">
            ...
            <ol class="breadcrumb breadcrumb-nav">
                ...
                <li class="group">
                    <a data-toggle="dropdown" href="#">Manage City</a>
                    <ul class="dropdown-menu dropdown-menu-arrow" role="menu">
                        <li role="presentation"><a role="menuitem" tabindex="-1" href="city_form.jsp">Add City</a></li>
                        <li role="presentation"><a role="menuitem" tabindex="-1" href="forms-masked-input-fields.html">Search City</a></li>
            ...
            <div class="row">
                ...
                <div class="col-md-6 col-lg-6">
                        <form action="<%=request.getContextPath() %>/city_controller" method="post" data-parsley-namespace="data-parsley-" data-parsley-validate>
                                ...
                                <div class="list-group">
                                    <div class="list-group-item">
                                        ...
                                        <div class="form-group">
											...
											<select class="form-control" id="source" name="st">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="ct" class="form-control" placeholder="Add City" data-parsley-required="true">
                                        </div>
										<div class="form-group">
                                            <label>City Description <span class="text-danger">*</span></label>
                                            <textarea class="form-control" name="cd" rows="5" placeholder="City Description"></textarea>
                                        </div>
                                     </div>
                                </div>
