    ...
    <body>
        ...
        <section class="wrapper retracted scrollable">
            ...
            <ol class="breadcrumb breadcrumb-nav">
                ...
                <li class="active">
                    <a  data-toggle="dropdown" href="#">Search Exam</a>
                ...
                <div class="col-md-12">
                    ...
                    <div class="panel panel-default panel-block">
                    	<div id="data-table" class="panel-heading datatable-heading">
                            <h4 class="section-title">Exam Table</h4>
                    	</div>
	                    <table class="table table-bordered table-striped" id="tableSortable">
	                        ...
	                        <c:forEach items="${sessionScope.list }" var="l">
	                            <tr>
	                            	...
	                            	<td>${l.no_q }</td>
	                            	<td>${l.e_desc }</td>
	                            	<td><a href="<%=request.getContextPath() %>/exam_controller?flag=loadsrc&id=${l.id }"><button type="button" class="btn btn-sm btn-primary">Update</button></a> | <a href="<%=request.getContextPath() %>/exam_controller?flag=delete&id=${l.id }"><button type="button" class="btn btn-sm btn-danger">Delete</button></a></td>
	                            	<td><a href="<%=request.getContextPath() %>/exam_controller?flag=exam&id=${l.id }"><button type="button" class="btn btn-sm btn-primary">Generate</button></a>	                            	
	                            </tr>
	                        </c:forEach>
	                        </tbody>
	                    </table>
