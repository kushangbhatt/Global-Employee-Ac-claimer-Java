        ...
        <section class="wrapper retracted scrollable">
            ...
            <div class="row">
                ...
                <div class="col-md-6 col-lg-6">
                        <form action="<%=request.getContextPath() %>/leave_controller" method="post" data-parsley-namespace="data-parsley-" data-parsley-validate>
                            <input type="hidden" name="flag" value="insert"/>
                            <div class="panel panel-default panel-block">
                                <div class="list-group">
                                    <div class="list-group-item">
                                        <h4 class="section-title">Leave Detail</h4>

                                        <div class="form-group">
                                            <label>Leave Type <span class="text-danger">*</span></label>
                                            <input type="text" name="lt" class="form-control" placeholder="Leave Type" data-parsley-required="true">
                                        </div>
										
										
										<div class="form-group">
                                            <label>No of Leave Allowed</label>
                                            <input type="text" name="no" class="form-control" placeholder="No of Leave Allowed" data-parsley-required="true">
                                        </div>
										<div class="form-group">
                                            <label>Leave Description</label>
                                            <textarea class="form-control" name="ld" rows="5" placeholder="Leave Description"></textarea>
                                        </div>
										                                    </div>
                                </div>
