	...
	<section class="wrapper retracted scrollable">
			...
			<li class="group"><a data-toggle="dropdown" href="#">Manage
				...
				<ul class="dropdown-menu dropdown-menu-arrow" role="menu">
					<li role="presentation"><a role="menuitem" tabindex="-1"
						href="question_form.jsp">Add Question</a></li>
					<li role="presentation"><a role="menuitem" tabindex="-1"
						href="forms-masked-input-fields.html">Search Question</a></li>
		...
		<div class="row">
			...
			<div class="col-md-6 col-lg-6">
				<form action="<%=request.getContextPath()%>/que_controller"
					...
					<div class="panel panel-default panel-block">
						<div class="list-group">
							<div class="list-group-item">
								<h4 class="section-title">Question&Answer</h4>
								<div class="form-group">
									<label>Subcategory <span class="text-danger">*</span></label> <select
										class="form-control" id="subcat_id" name="subcat">
										<option value="Select Country">Select Subcategory</option>
										<c:forEach items="${sessionScope.list }" var="i">
											<option value="${i.id }">${i.subcat }</option>
										</c:forEach>
									</select>
								</div>
								...
								<div class="form-group">
									...
									<textarea class="form-control" name="q" rows="5"
								...
								<div class="form-group">
									...
									<div class="form-group">
										<label>Option 1 <span class="text-danger">*</span></label> <input
											type="text" class="form-control" name="o1"
											placeholder="Option1" data-parsley-required="true" />
									</div>
									<div class="form-group">
										<label>Option 2 <span class="text-danger">*</span></label> <input
											type="text" class="form-control" name="o2"
											placeholder="Option2" data-parsley-required="true" />
									</div>
									<div class="form-group">
										<label>Option 3 <span class="text-danger">*</span></label> <input
											type="text" class="form-control" name="o3"
											placeholder="Option3" data-parsley-required="true" />
									</div>
									<div class="form-group">
										<label>Option 4 <span class="text-danger">*</span></label> <input
											type="text" class="form-control" name="o4"
											placeholder="Option4" data-parsley-required="true" />
									</div>

								</div>
								<div class="form-group">
									<label>Right Answer</label> <input type="text"
										class="form-control" name="ra" placeholder="Right Answer"
										data-parsley-required="true">
								</div>
								<div class="form-group">
									<label>Marks</label> <input type="text" class="form-control"
										name="m" placeholder="Marks" data-parsley-required="true">
								</div>
							</div>
						</div>
