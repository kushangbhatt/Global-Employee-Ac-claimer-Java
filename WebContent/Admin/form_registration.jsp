  ...
  function loadCity()
	{
		...
		xmlhttp.open("get","${pageContext.request.contextPath}/reg_controller?flag=loadcity&state_id="+state_id.value, true);
		xmlhttp.send();
		/* jQuery(".chosen-select1").chosen({'width':'100%','white-space':'nowrap'}); */
		/* Holds the status of the XMLHttpRequest. Changes from 0 to 4:
			0: request not initialized
  ...
  function check()
	{
		...
		xmlhttp.open("get","${pageContext.request.contextPath}/login_controller?flag=check&uname="+uname.value, true);
		xmlhttp.send();
		/* jQuery(".chosen-select1").chosen({'width':'100%','white-space':'nowrap'}); */
		/* Holds the status of the XMLHttpRequest. Changes from 0 to 4:
			0: request not initialized
							...
							<div class="list-group-item">
								...
								<div class="form-group">
									<label>Email <span class="text-danger">*</span></label> <input
										...
										data-parsley-type="email" data-parsley-required="true" onblur="check()">
								</div>
