...
<script>
	function loadState() {
		...
		xmlhttp.onreadystatechange = function() {
			if (xmlhttp.readyState == 4) {
				...
				for (i = 0; i < jsonObj.length; i++) {
					...
					document.cityForm.st.options.add(createOption);
		...
		xmlhttp.open("get",
				"${pageContext.request.contextPath}/city_controller?flag=loadst&country_id="
						+ country_id.value, true);
		xmlhttp.send();
...
<body>
	...
	<section class="wrapper retracted scrollable">
		...
		<div class="ui-pnotify "
			style="width: 300px; opacity: 1; display: block; right: 25px; top: 70px; cursor: auto;">
			<div
				class="alert ui-pnotify-container alert-success ui-pnotify-sharp"
				...
				<h4 class="ui-pnotify-title">Drag & Drop</h4>
				<div class="ui-pnotify-text">Reorder Widgets or Quicklaunch
					bar items by dragging & dropping them.</div>
			</div>
		</div>
			...
			<li class="group"><a data-toggle="dropdown" href="#">Manage
				...
				<ul class="dropdown-menu dropdown-menu-arrow" role="menu">
					<li role="presentation"><a role="menuitem" tabindex="-1"
						href="city_form.jsp">Add City</a></li>
					<li role="presentation"><a role="menuitem" tabindex="-1"
						href="search_city.jsp">Search City</a></li>
		...
		<div class="row">
			...
			<div class="col-md-6 col-lg-6">
				<form action="<%=request.getContextPath()%>/city_controller"
					name="cityForm" method="post"
					data-parsley-namespace="data-parsley-" data-parsley-validate>
					<input type="hidden" name="flag" value="insert" />
					<div class="panel panel-default panel-block">
						<div class="list-group">
							<div class="list-group-item">
								<h4 class="section-title">City Details</h4>

								<div class="form-group">
									<label>Country <span class="text-danger">*</span></label> <select
										class="form-control" id="country_id" name="cnt"
										onchange="loadState()">
								...
								<div class="form-group">
									<label>State <span class="text-danger">*</span></label> <select
										class="form-control" id="state_id" name="st">
								...
								<div class="form-group">
									<label>City <span class="text-danger">*</span></label> <input
										type="text" name="ct" class="form-control"
										placeholder="Add City" data-parsley-required="true">
								</div>
								<div class="form-group">
									<label>City Description <span class="text-danger">*</span></label>
									<textarea class="form-control" name="cd" rows="5"
	...
	<script src="Js/8b870695.ui-components-general.js"></script>
