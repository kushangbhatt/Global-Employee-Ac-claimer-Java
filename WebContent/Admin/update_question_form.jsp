...
<!--[if gt IE 9]><!--> <html class="no-js"> <!--<![endif]-->
    <head>
        ...
        <title>GEA - Question And Answer</title>
    ...
    <body>
        ...
        <section class="wrapper retracted scrollable">
            ...
            <ol class="breadcrumb breadcrumb-nav">
                ...
                <li class="group">
                    <a data-toggle="dropdown" href="#">Manage Question</a>
                    <ul class="dropdown-menu dropdown-menu-arrow" role="menu">
                        <li role="presentation"><a role="menuitem" tabindex="-1" href="question_form.jsp">Add Question</a></li>
                        <li role="presentation"><a role="menuitem" tabindex="-1" href="forms-masked-input-fields.html">Search Question</a></li>
            ...
            <div class="row">
                ...
                <div class="col-md-6 col-lg-6">
                        <form action="<%=request.getContextPath() %>/que_controller" method="post" data-parsley-namespace="data-parsley-" data-parsley-validate>
                                ...
                                <div class="list-group">
                                    <div class="list-group-item">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <textarea class="form-control" name="q" rows="5" placeholder="Question">${l.que }</textarea>
                                        </div>
										...
										<div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name="o1" value="${l.o1 }" data-parsley-required="true"/>
                                        </div>
                                        <div class="form-group">
                                            <label>Option 2 <span class="text-danger">*</span></label>
                                            <input type="text" class="form-control" name="o2" value="${l.o2 }" data-parsley-required="true"/>
                                        </div>
                                        <div class="form-group">
                                            <label>Option 3 <span class="text-danger">*</span></label>
                                            <input type="text" class="form-control" name="o3" value="${l.o3 }" data-parsley-required="true"/>
                                        </div>
                                        <div class="form-group">
                                            <label>Option 4 <span class="text-danger">*</span></label>
                                            <input type="text" class="form-control" name="o4" value="${l.o4 }" data-parsley-required="true"/>
                                        </div>
										
										</div>
										<div class="form-group">
                                            <label>Right Answer</label>
                                            <input type="text" class="form-control" name="ra" value="${l.ra }" data-parsley-required="true">
                                        </div>
										<div class="form-group">
                                            <label>Marks</label>
                                            <input type="text" class="form-control" name="m" value="${l.m }" data-parsley-required="true">
                                        </div>
                                        </c:forEach>
									</div>
                                </div>
